                            ...
                            <tr>
                              <td style='width:230px;'>
                                <a href='# Logo Url' target='_blank'>
                                  <img alt='LoGo Here' height='80' src='https://assets.opensourceemails.com/imgs/mantra/logo.png' style='border:0;display:block;font-size:13px;height:80px;outline:none;text-decoration:none;width:100%;' width='230' />
                                </a>
                              </td>
                            </tr>
                          </tbody>
                          ...
                          <tbody>
                            <tr>
                              <td style='width:333px;'>
                                <img alt='title' height='303' src='https://www.graphicmore.com/wp-content/uploads/2019/04/Happy-Birthday-Card-with-Colorful-Balloons-Vector-Download.jpg' style='border:0;display:block;font-size:13px;height:303px;outline:none;text-decoration:none;width:100%;' width='333' />
                              </td>
                            </tr>
                          </tbody>
                        </table>
