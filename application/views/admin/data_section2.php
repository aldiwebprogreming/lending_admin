          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="<?= base_url() ?>section/section2" class="btn btn-primary mb-5"><i class="fas fa-plus"></i> Tambah Data</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr> 
                    ...
                    <td>
                     <a id="hapus" href="<?= base_url('section/') ?>hapus_section2?id=<?= $data['id'] ?>" onclick="return confirm('Yakin Hapus?')" class="badge badge-danger">Hapus</a>

                      <a href="<?= base_url('section/') ?>edit_section2?id=<?= $data['id'] ?>" class="badge badge-success">Edit</a>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Detail Section 2</h5>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <img src="<?= base_url() ?>assets/gambar_section2/<?= $data['img_card1'] ?>" alt="..." class="img-thumbnail" style="height: 100px;">
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                 ...
                                 <img src="<?= base_url() ?>assets/gambar_section2/<?= $data['img_card2'] ?>" alt="..." class="img-thumbnail" style="height: 100px;">
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                  ...
                                  <img src="<?= base_url() ?>assets/gambar_section2/<?= $data['img_card3'] ?>" alt="..." class="img-thumbnail" style="height: 100px;">
                                </div>
                                <hr>
