          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                   <div class="col-lg-6">
                <form method="post" action="<?= base_url() ?>section/action_editcard2" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <a href="<?= base_url() ?>section/data_section2"  class = "btn btn-success">Kembali</a>
                  </div>
