              ...
              <div class="card-body">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Masukan judul" name="judul" required="">
                  </div>

                  <div class="form-group">
                    <label for="formGroupExampleInput">Sub judul</label>
                    <textarea class="form-control" name="sub_judul" required="" placeholder="Masukan sub judul halaman"></textarea>
                  </div>
